...
export function loadAll() {
    const configs = readJson(CONFIG_FILES.MAIN, [
    ...
    const workspaces = readJson(CONFIG_FILES.WORKSPACE, [
    ...
    const skills = readJson(CONFIG_FILES.SKILLS, [
    ...
    const plugins = readJson(CONFIG_FILES.PLUGINS, [
