...
export class ProviderManager {
    register() {
        ...
        ipcMain.handle(IPC_CHANNELS.PROVIDER_CREATE, async (_e, data) => this.create(data));
        ipcMain.handle(IPC_CHANNELS.PROVIDER_UPDATE, async (_e, provider) => this.update(provider));
        ipcMain.handle(IPC_CHANNELS.PROVIDER_DELETE, async (_e, id) => this.delete(id));
        ipcMain.handle(IPC_CHANNELS.PROVIDER_TEST, async (_e, id) => this.test(id));
    }
    create(data) {
